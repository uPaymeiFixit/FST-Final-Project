...
<body>
  ...
  <div id="header">
    ...
    <ul id="menu">
      ...
      <li class="tab_selected"><a href="age">Age Statistics</a></li>
  ...
  <div id="site_content">
    ...
    <h1 style="position:relative;top:-270px;left:0px;">Age Box Plot</h1>
    <div id="chart2" style="height:200px;width:600px;position:relative;top:-270px;left:0px; "></div>

    <h1 style="position:relative;top:-270px;left:0px;">Age Bar Graph</h1>
...
$(document).ready(function(){
  ...
  ctx.graphBoxPlot( age, 40, 20, 500, 120 );
...
$("#Mean")[0].innerText = Math.round(stats.mean(age));
$("#Median")[0].innerText = Math.round(stats.median(age));
$("#Mode")[0].innerText = stats.mode(age);
$("#Sx")[0].innerText = Math.round(stats.Sx(age));
$("#Q1")[0].innerText = Math.round(stats.Q1(age));
$("#Q3")[0].innerText = Math.round(stats.Q3(age));
$("#Min")[0].innerText = Math.round(stats.min(age));
$("#Max")[0].innerText = Math.round(stats.max(age));
$("#IQR")[0].innerText = Math.round(stats.IQR(age));
$("#Range")[0].innerText = Math.round(stats.range(age));
$("#Outliers")[0].innerText = stats.outliers(age);
